...
keyboard.keymap = [
    [   # 0.QWY - Qwerty/Base layer
        ...
        LWRL,       SHSPC,      KC.BSPC,    KC.LGUI,    KC.LALT,    KC.LCTL,            KC.QUOT,    CAT,        KC.MINS,    KC.ENT,     KC.SPC,     ADJ
    ],
    ...
    [   # 2.LWR - Numbers and symbols
        ...
        KC.TRNS,    SHSPC,      KC.BSPC,    KC.LGUI,    KC.LALT,    KC.LCTL,            KC.QUOT,    CAT,        KC.MINS,    KC.ENT,     KC.SPC,     ADJ
    ],
    [   # 3.RSE - Direction and CTRL based hot keys
        XXX,        ALTF4,      KC.LCTL,    SCCAP,      CTSH,       KC.LSFT,            CTY,        KC.HOME,    KC.END,     KC.PGUP,    KC.PGDN,    XXX,        
        KC.TRNS,    CTA,        CTS,        CTX,        CTC,        CTV,                XXX,        KC.LEFT,    KC.DOWN,    KC.UP,      KC.RGHT,    XXX,        
        XXX,        CTZ,        CTI,        CTB,        CTF,        CTENT,              XXX,        XXX,        GCRGHT,     GCLEFT,     XXX,        XXX,        
                                KC.TRNS,    SAI,                                                                GSRGHT,     GSLEFT,
        CTTAB,      MUTET,      VIDT,       KC.PGUP,    HANDT,      KC.PGDN,            XXX,        XXX,        XXX,        XXX,        XXX,        XXX
    ],
    [   # 4.ADJ - Text combos and function keys
        XXX,        KC.F1,      KC.F2,      KC.F3,      KC.F4,      KC.F5,              KC.F6,      KC.F7,      KC.F8,      KC.F9,      KC.F10,     XXX,      
        XXX,        XXX,        OLDPASS3,   OLDPASS2,   OLDPASS,    WKPAUG,             RABSC,      XXX,        XXX,        KC.F11,     KC.F12,     XXX,      
        XXX,        TEAMCT,     OWTTU,      OWSH,       OWTT,       PKH,                MYEMAIL,    UID,        CURPASS,    XXX,        XXX,        XXX,      
                                QWY,        KC.RESET,                                                           KC.RESET,   CDH,
        CURPASS,    UID,        MYEMAIL,    RABSC,      HANGMANL,   HANGMANU,           XXX,        XXX,        XXX,        XXX,        XXX,        KC.TRNS
    ],
]
